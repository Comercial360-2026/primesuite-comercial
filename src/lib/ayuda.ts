...
const _PANTALLAS = {
  ...
  'detalle-hallazgo': {
    ...
    ojo: 'Archivar, borrar y cambiar de tipo solo los puede hacer el autor del hallazgo o Dirección Comercial. Editar y borrar sigue disponible con la visita cerrada. Si sales con algo sin guardar, la app te avisa.',
  },
  'detalle-oportunidad': {
    grupo: 'registro',
    titulo: 'Oportunidad',
